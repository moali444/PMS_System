...
//   const isActivated = userInformation?.isActivated === true;
//   const navigate = useNavigate();
//   const getProject = async () => {
//     setIsLoading(true);
//     try {
//       const response = await axios.get(USERS_URLS.getList, {
//         params: {
...
const UsersData = () => {
  ...
  const getProject = async () => {
    ...
    try {
      ...
      console.log(response.data);
      setUsersList(response.data.data); // Assuming response.data.data includes isActivated for each user
      setPaginationInfo({
        ...paginationInfo,
        totalNumberOfPages: response.data.totalNumberOfPages,
        totalNumberOfRecords: response.data.totalNumberOfRecords,
